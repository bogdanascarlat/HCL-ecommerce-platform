    ...
    >
      <div className="d-flex card" style={{ height: "100%" }}>
        ...
        <div className="d-flex row card-body px-4">
          ...
          <p className="mb-0 align-self-end" style={{fontSize: ".7em"}}>MSRP: ${price}</p>
          { <p className="card-text fw-bold align-self-end mt-0">Price: ${(price*(1-discountPercentage/100)).toFixed(2)}</p> }
          <button
