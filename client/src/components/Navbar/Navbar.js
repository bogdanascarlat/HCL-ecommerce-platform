  ...
  return (
    <>
      ...
      >
        ...
        <Link to="/wishlist" className="nav-link position-relative ml-5 mr-5">
          <svg
            className="pe-1"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
      ...
      >
        <Link to="/profile2" className="nav-link">
          <svg
            className="pe-1"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
